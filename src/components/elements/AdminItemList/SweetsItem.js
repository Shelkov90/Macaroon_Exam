...
class SweetsItem extends PureComponent {
    constructor(props) {
        super(props)
    ...
    saveEditableSweet = async (key, id, sweet) => { 
        this.props.updateProductData(key, id, sweet)
        this.removeEditStatus();
    }

    deleteSweet = async (key, id) => {
    ...
    render() {
        ...
        let sweetTastes = item.details[0].tastes;
            ...
            <div className='news__item grid grid-cols-8 gap-x-2 rounded-xl shadow-md my-2 bg-white p-4'>
                ...
                <div className='col-span-4'>
                    ...
                    <p className='text-balance'>
                        ...
                        {editable ? 
                        <input 
                            onChange={(e) => {sweet.name = e.target.value}} 
                    ...
                    <p>
                        ...
                        ${editable ? 
                        <input 
                            onChange={(e) => {sweet.price = e.target.value}} 
                            className='border border-blue-400 w-full' 
                            type="number" 
                    ...
                    <p>
                        ...
                        {editable ? 
                        <input 
                            onChange={(e) => {sweet.discount = e.target.value}} 
                            className='border border-blue-400 w-full' 
                            type="number" 
                    ...
                    <div>
                        <div className='bg-gray-100 rounded-md my-2 p-4'>
                            ...
                            <p className='my-1'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].description[0].header = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                            ...
                            <p className='my-1 text-balance'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].description[0].text = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                        ...
                        <div className='bg-gray-100 rounded-md my-2 p-4'>
                            ...
                            <p className='my-1'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].compound[0].header = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                            ...
                            <p className='my-1 text-balance'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].compound[0].text = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                        ...
                        <div className='bg-gray-100 rounded-md my-2 p-4'>
                            ...
                            <p className='my-1'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].conditionsconditions[0].header = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                            ...
                            <p className='my-1 text-balance'>
                                ...
                                {editable ? 
                                <input 
                                    onChange={(e) => {sweet.details[0].conditions[0].text = e.target.value}} 
                                    className='border border-blue-400 w-full' 
                                    type="text" 
                ...
                <p className='col-span-2'>
                    {editable ? 
                    <input 
                        onChange={(e) => {sweet.image = e.target.value}} 
                        className='border border-blue-400 w-full' 
                        type="text" 
                ...
                {editable ? 
                <button onClick={() => this.saveEditableSweet("sweets", item.id, sweet)} className='bg-green-200 hover:bg-green-400 rounded-md mx-2 max-h-56'>SAVE</button> : 
                <button onClick={() => this.sweetEditStatus()} className='bg-green-200 hover:bg-green-400 rounded-md mx-2 max-h-56'>EDIT</button>
                }
                <button onClick={() => this.deleteSweet("products", item.id)} className='bg-red-200 hover:bg-red-400 rounded-md mx-2 max-h-56'>DELETE</button>
