		...
		return (
			<header >
				...
				{/* 		
						...
						<p className="uppercase text-gray-600">оптовые поставки от производителя</p>
				...
				<div className="flex justify-between text-sm max-w-[1400px] mx-auto py-3 px-2">
					...
					<div className="flex items-center basis-1/6 justify-end">
						<div className="ml-4"><img className="size-8" src="images/tg.svg" alt="alt"/></div>
						<div className="ml-4"><img className="size-6" src="images/instagram.png" alt="alt"/></div>
						<div className="ml-4"><img className="size-6" src="images/fb_logo.png" alt="alt"/></div>
					</div>
